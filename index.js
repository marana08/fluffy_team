import{a as G,i as h,S as Q,N as se,P as re,A as ie,R as le,b as J}from"./assets/vendor-DfcDIlvk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const i={categoryList:document.querySelector(".js-category-list"),petsList:document.querySelector(".js-pets-list"),loader:document.querySelector(".js-loader"),petsLoadMoreBtn:document.querySelector(".js-pets-load-more-btn"),petsListPagination:document.querySelector(".pagination"),animalDetailsBackdrop:document.querySelector(".animal-details-backdrop")},w={page:3,limit:6},P="/fluffy_team/assets/sprite-C5gMIK71.svg";function g(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(n){console.error("Error saving to LocalStorage:",n)}}function O(e){try{const t=localStorage.getItem(e);return t?JSON.parse(t):null}catch(t){return console.error("Error loading from LocalStorage:",t),null}}let X=null;function ce(e){X=e}function H(){return X}i.animalDetailsBackdrop.addEventListener("click",pe);function de(e){const n=O("animals").find(d=>d._id===e);if(!n)return;ue(n),i.animalDetailsBackdrop.classList.add("is-open"),document.body.style.overflow="hidden";const s=document.querySelector(".animal-modal");j(s);const a=document.querySelector(".details-modal-close-btn");window.addEventListener("keydown",R),a.addEventListener("click",N);const o=document.querySelector(".modal-adopt-btn");o&&o.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-order-modal",{detail:{animalId:n._id}}))})}function ue({_id:e,name:t,image:n,species:s,age:a,gender:o,description:d,healthStatus:l,behavior:c}){const p=`
  ...
  `;i.animalDetailsBackdrop.innerHTML=p}function N(){i.animalDetailsBackdrop.classList.remove("is-open"),document.body.style.overflow="",window.removeEventListener("keydown",R);const e=H();e&&e.focus()}function R(e){e.key==="Escape"&&N()}function pe(e){e.currentTarget===e.target&&N()}function j(e){e.focus();const n=e.querySelectorAll(`
    a[href],
    button:not([disabled]),
    textarea,
    input,
  ...
  `),s=n[0],a=n[n.length-1];e.addEventListener("keydown",o=>{o.key==="Tab"&&(o.shiftKey&&document.activeElement===s&&(o.preventDefault(),a.focus()),!o.shiftKey&&document.activeElement===a&&(o.preventDefault(),s.focus()))})}const Z=document.querySelector(".header-burger-menu"),I=document.querySelector(".header-modal"),me=document.querySelector(".modal-close-button");document.querySelector(".modal-navigation-item");const fe=document.querySelector(".modal-navigation-list"),ge=document.querySelector(".modal-button");function B(e){I.classList.remove("is-open"),document.body.classList.remove("is-modal-open"),document.removeEventListener("keydown",ee),Z.blur()}function ee(e){e.key==="Escape"&&B()}ge.addEventListener("click",B);Z.addEventListener("click",e=>{e.preventDefault(),I.classList.add("is-open"),document.body.classList.add("is-modal-open"),document.addEventListener("keydown",ee),j(I)});me.addEventListener("click",B);fe.addEventListener("click",e=>{e.target.classList.contains("modal-navigation-link")&&B()});const ye="https://paw-hut.b.goit.study/api",q={animals:"/animals",categories:"/categories",orders:"/orders",feedbacks:"/feedbacks"},$=G.create({baseURL:ye});async function ve(e=w.page){try{const t=typeof w.limit=="number"&&w.limit>0?w.limit:6,n=typeof e=="number"&&e>=1?e:1;return(await $.get(`${q.feedbacks}`,{params:{limit:t,page:n}})).data.feedbacks}catch{return null}}let F=he(),r=O("page"),U,m=O("categoryId")??null;document.addEventListener("DOMContentLoaded",be);i.petsLoadMoreBtn.addEventListener("click",we);i.categoryList.addEventListener("click",Le);i.petsListPagination.addEventListener("click",Se);i.petsList.addEventListener("click",Ee);function he(){return window.innerWidth>=1440?9:8}function _(){return Math.ceil(U/F)}async function be(e){C(),r=1,m=null,g("page",1),g("categoryId",null);try{const t=await ke(),n=await x();$e(t),V(n),z(),k()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M()}}async function Le(e){if(e.target.nodeName!=="BUTTON")return;const t=e.target.textContent;m=e.target.closest("li").dataset.id,r=1;let s;C(),i.categoryList.querySelectorAll(".category-btn").forEach(o=>{o.classList.remove("current")}),e.target.classList.add("current");try{t!=="Всі"?s=await K(m,r):s=await x(),V(s),k(),z(),i.petsList.querySelector("li").focus()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),g("categoryId",m),g("page",r)}}async function we(){r+=1,C();try{if(m){k();const t=await K(m,r),n=D(t);i.petsList.insertAdjacentHTML("beforeend",n)}else{k();const t=await x(r),n=D(t);i.petsList.insertAdjacentHTML("beforeend",n)}const e=i.petsList.querySelector("li");if(e){const t=e.getBoundingClientRect();window.scrollBy({top:t.height,behavior:"smooth"})}}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),g("page",r)}}async function Se(e){const t=e.target.closest("button");if(!t)return;let n;C();const s=_();t.dataset.action==="prev"&&r>1&&(r-=1),t.dataset.action==="next"&&r<s&&(r+=1),t.dataset.page&&(r=Number(t.dataset.page));try{m?n=await K(m,r):n=await x(r),V(n),z(),window.scrollTo({top:i.petsList.offsetTop-80,behavior:"smooth"});const a=i.petsList.querySelector("li");a&&a.focus()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),g("page",r)}}function Ee(e){const t=e.target.closest(".pets-button");if(!t)return;const n=t.closest("li");if(!n)return;const s=n.dataset.id;ce(t),de(s)}async function ke(e){return(await $.get(`${q.categories}`)).data}async function x(e){const t=await $.get(`${q.animals}`,{params:{limit:F,page:e}});return U=t.data.totalItems,t.data.animals}async function K(e,t){const n=await $.get(`${q.animals}?categoryId=${e}`,{params:{limit:F,page:t}});return U=n.data.totalItems,n.data.animals}function Be(e){return`
     ...
     <div class="pets-img-wrapper"><img class="pets-img" loading="lazy" src="${n}" alt="${t} - ${s}" /></div>
      ...
      </li>`}function D(e){return e.map(xe).join("")}function V(e){const t=D(e);i.petsList.innerHTML=t,g("animals",e)}function z(){const e=_();if(e<=1)return;let t="";if(t+=`<li>
