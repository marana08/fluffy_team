import{a as Y,i as h,S as G,N as se,P as re,A as ie,R as le,b as z}from"./assets/vendor-DfcDIlvk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const r={categoryList:document.querySelector(".js-category-list"),petsList:document.querySelector(".js-pets-list"),loader:document.querySelector(".js-loader"),petsLoadMoreBtn:document.querySelector(".js-pets-load-more-btn"),petsListPagination:document.querySelector(".pagination"),animalDetailsBackdrop:document.querySelector(".animal-details-backdrop")},w={page:1,limit:6},P="/fluffy_team/assets/sprite-C5gMIK71.svg";function g(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(n){console.error("Error saving to LocalStorage:",n)}}function O(e){try{const t=localStorage.getItem(e);return t?JSON.parse(t):null}catch(t){return console.error("Error loading from LocalStorage:",t),null}}let Q=null;function ce(e){Q=e}function H(){return Q}r.animalDetailsBackdrop.addEventListener("click",pe);function de(e){const n=O("animals").find(d=>d._id===e);if(!n)return;ue(n),r.animalDetailsBackdrop.classList.add("is-open"),document.body.style.overflow="hidden";const s=document.querySelector(".animal-modal");R(s);const a=document.querySelector(".details-modal-close-btn");window.addEventListener("keydown",X),a.addEventListener("click",N);const o=document.querySelector(".modal-adopt-btn");o&&o.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-order-modal",{detail:{animalId:n._id}}))})}function ue({_id:e,name:t,image:n,species:s,age:a,gender:o,description:d,healthStatus:l,behavior:c}){const p=`
  ...
  `;r.animalDetailsBackdrop.innerHTML=p}function N(){r.animalDetailsBackdrop.classList.remove("is-open"),document.body.style.overflow="",window.removeEventListener("keydown",X);const e=H();e&&e.focus()}function X(e){e.code==="Escape"&&N()}function pe(e){e.currentTarget===e.target&&N()}function R(e){e.focus();const n=e.querySelectorAll(`
    a[href],
    button:not([disabled]),
    textarea,
    input,
  ...
  `),s=n[0],a=n[n.length-1];e.addEventListener("keydown",o=>{o.key==="Tab"&&(o.shiftKey&&document.activeElement===s&&(o.preventDefault(),a.focus()),!o.shiftKey&&document.activeElement===a&&(o.preventDefault(),s.focus()))})}const Z=document.querySelector(".header-burger-menu"),I=document.querySelector(".header-modal"),me=document.querySelector(".modal-close-button");document.querySelector(".modal-navigation-item");const fe=document.querySelector(".modal-navigation-list"),ge=document.querySelector(".modal-button");function B(e){I.classList.remove("is-open"),document.body.classList.remove("is-modal-open"),document.removeEventListener("keydown",ee),Z.blur()}function ee(e){e.key==="Escape"&&B()}ge.addEventListener("click",B);Z.addEventListener("click",e=>{e.preventDefault(),I.classList.add("is-open"),document.body.classList.add("is-modal-open"),document.addEventListener("keydown",ee),R(I)});me.addEventListener("click",B);fe.addEventListener("click",e=>{e.target.classList.contains("modal-navigation-link")&&B()});const ye="https://paw-hut.b.goit.study/api",q={animals:"/animals",categories:"/categories",orders:"/orders",feedbacks:"/feedbacks"},$=Y.create({baseURL:ye});async function ve(e=w.page){try{const t=typeof w.limit=="number"&&w.limit>0?w.limit:6,n=typeof e=="number"&&e>=1?e:1;return(await $.get(`${q.feedbacks}`,{params:{limit:t,page:n}})).data.feedbacks}catch{return null}}let j=he(),i=O("page"),F,m=O("categoryId")??null;document.addEventListener("DOMContentLoaded",be);r.petsLoadMoreBtn.addEventListener("click",we);r.categoryList.addEventListener("click",Le);r.petsListPagination.addEventListener("click",Se);r.petsList.addEventListener("click",Ee);function he(){return window.innerWidth>=1440?9:8}function U(){return Math.ceil(F/j)}async function be(e){C(),i=1,m=null,g("page",1),g("categoryId",null);try{const t=await ke(),n=await x();$e(t),K(n),V(),k()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M()}}async function Le(e){if(e.target.nodeName!=="BUTTON")return;const t=e.target.textContent;m=e.target.closest("li").dataset.id,i=1;let s;C(),r.categoryList.querySelectorAll(".category-btn").forEach(o=>{o.classList.remove("current")}),e.target.classList.add("current");try{t!=="Всі"?s=await _(m,i):s=await x(),K(s),k(),V(),r.petsList.querySelector("li").focus()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),g("categoryId",m),g("page",i)}}async function we(){i+=1,r.loader.classList.add("loader-center"),C();try{if(m){k();const t=await _(m,i),n=D(t);r.petsList.insertAdjacentHTML("beforeend",n)}else{k();const t=await x(i),n=D(t);r.petsList.insertAdjacentHTML("beforeend",n)}const e=r.petsList.querySelector("li");if(e){const t=e.getBoundingClientRect();window.scrollBy({top:t.height,behavior:"smooth"})}}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),g("page",i),r.loader.classList.remove("loader-center")}}async function Se(e){const t=e.target.closest("button");if(!t)return;let n;r.loader.classList.add("loader-center"),C();const s=U();t.dataset.action==="prev"&&i>1&&(i-=1),t.dataset.action==="next"&&i<s&&(i+=1),t.dataset.page&&(i=Number(t.dataset.page));try{m?n=await _(m,i):n=await x(i),K(n),V(),window.scrollTo({top:r.petsList.offsetTop-80,behavior:"smooth"});const a=r.petsList.querySelector("li");a&&a.focus()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),r.loader.classList.remove("loader-center"),g("page",i)}}function Ee(e){const t=e.target.closest(".pets-button");if(!t)return;const n=t.closest("li");if(!n)return;const s=n.dataset.id;ce(t),de(s)}async function ke(e){return(await $.get(`${q.categories}`)).data}async function x(e){const t=await $.get(`${q.animals}`,{params:{limit:j,page:e}});return F=t.data.totalItems,t.data.animals}async function _(e,t){const n=await $.get(`${q.animals}?categoryId=${e}`,{params:{limit:j,page:t}});return F=n.data.totalItems,n.data.animals}function Be(e){return`
     ...
     <div class="pets-img-wrapper"><img class="pets-img" src="${n}" alt="${t} - ${s}" /></div>
      ...
      </li>`}function D(e){return e.map(xe).join("")}function K(e){const t=D(e);r.petsList.innerHTML=t,g("animals",e)}function V(){const e=U();if(e<=1)return;let t="";if(t+=`<li>
